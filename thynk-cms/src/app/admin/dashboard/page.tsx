...
export default function AdminDashboard() {
  ...
  // NOTE: data_entries.<field> is already a rolled-up total of that entry's
  // campaign_updates (kept in sync by resync() in data-panel/page.tsx every
  // time an update is added/edited/deleted). So the totals below must come
  // from `entries` ONLY — adding campaign_updates on top double-counts them.
